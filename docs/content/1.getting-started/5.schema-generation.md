...
Raw: https://better-auth.nuxt.dev/raw/getting-started/schema-generation.md
Source: https://github.com/onmax/nuxt-better-auth/blob/main/docs/content/1.getting-started/5.schema-generation.md
```
