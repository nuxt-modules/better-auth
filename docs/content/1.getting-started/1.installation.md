...
Raw: https://better-auth.nuxt.dev/raw/getting-started/installation.md
Source: https://github.com/onmax/nuxt-better-auth/blob/main/docs/content/1.getting-started/1.installation.md
```
