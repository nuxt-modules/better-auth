...
Docs: https://better-auth.nuxt.dev/getting-started/type-augmentation
Raw: https://better-auth.nuxt.dev/raw/getting-started/type-augmentation.md
Source: https://github.com/onmax/nuxt-better-auth/blob/main/docs/content/1.getting-started/4.type-augmentation.md
```
