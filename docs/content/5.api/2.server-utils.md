...
interface AuthInstance {
  api: {
    getSession(input: { headers: HeadersInit }): Promise<AppSession | null>
  }
}
...
declare function serverAuth(event?: H3Event): AuthInstance
declare function createError(input: { statusCode: number }): Error
