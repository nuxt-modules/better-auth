...
export function useUserSignUp<TMethod extends keyof SignUp>(method: TMethod): ActionHandleFor<SignUp[TMethod]> {
  ...
  return handles[method] as ActionHandleFor<SignUp[TMethod]>
}
